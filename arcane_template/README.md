...
A Flutter template project using the Arcane UI framework - a Material Design-free UI system with pure Arcane components.
...
- **Theme Management**: Built-in light/dark/system theme toggle
...
4. **Modify screens**: Customize screens in `lib/screens/`
5. **Generate assets**: Run icon and splash generators
...
- [GitHub Issues](https://github.com/ArcaneArts/arcane/issues) - Arcane framework issues
